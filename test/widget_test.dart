...
void main() {
  ...
  group('service fetchDataFuture()', () {
    ...
    test('server responds with empty list, returns Exception: Empty', () async {
      ...
      expect(
          () async => await service.fetchDataFuture(),
          throwsA(predicate(
              (e) => e is Exception && e.toString() == 'Exception: Empty')));
    });
    ...
    test('bad request, returns Exception: Error fetching data', () async {
      ...
      expect(
          ...
          throwsA(predicate((e) =>
              e is Exception &&
              e.toString() == 'Exception: Error fetching data')));
    });
    ...
    test('bad request, returns Exception: Error fetching data', () async {
      ...
      expect(
          () async => await service.fetchDataFuture(),
          throwsA(predicate((e) =>
              e is Exception && e.toString() == 'Exception: Server error')));
    });
  });
  ...
  group('service fetchDataStream()', () {
    ...
    test('server responds with empty list, emits loading then Exception: Empty', () async {
      ...
      expect(service.fetchDataStream(),
          emitsInOrder([
            predicate((o) => o is Loading),
            predicate((o) => o is Error && (o.exception).toString() == 'Exception: Empty')
          ]));
    });
    ...
    test('server responds with error, emits loading then Exception: Server error', () async {
      ...
      expect(service.fetchDataStream(),
          emitsInOrder([
            predicate((o) => o is Loading),
            predicate((o) => o is Error && o.exception.toString() == 'Exception: Server error')
          ]));
    });
  });
}
